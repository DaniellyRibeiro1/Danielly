...
//Declarando viriável sem dados (undefined)
let nota;
//declarando variável com informação 
let nome = "Carlos";

//Reatribuindo um valor à viriável nome
nome = "Roberto";
nota = 8.5;

//Entrada de dados em nosso programa 
let sobrenome = prompt('Digite seu sobrenome')
let nota1 = Number(prompt('Digite  a nota da 1ª prova: ª'))
let nota2 =Number(prompt('Digite  a nota da 2ª prova: ª'))

//Peocessamento dos dados
...
console.log(`O seu nome é: ${nomeComplto} '\n sua idade' + ${idade}`);
console.log(`O seu nome é: ' + nomeComplto '\n sua idade' + idade`);
